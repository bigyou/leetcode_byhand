...
//
//import in.kaixin.leetcode_byhand.other.MaximizeSquareArea;
//
...
////            for (int j = 0; j+len< mat[0].length; ) {
////                int foursum =
////                        v[i][j + len] - v[i][j] - mat[i][j + len]
////                                + v[i + len][j + len] - v[i + len][j] - mat[i + len][j + len]
////                                + h[i + len][j] - h[i][j] - mat[i + len][j]
////                                + h[i + len][j + len] - h[i][j + len] - mat[i + len][j + len] + mat[i][j] + mat[i + len][j] + mat[i][j + len] + mat[i + len][j + len];
////                if (foursum <= threshold) {
////                    res = len;
////                    len++;
////                } else {
////                    j++;
...
//        }
//        int total = mat[0][0];
//        for (int i = 0; i + maxwidth < mat.length; i++) {
//            for (int j = 0; j + maxwidth < mat[0].length; j++) {
//                if (total <= threshold) {
//                    maxwidth++;
//                    total += v[i + maxwidth][j + maxwidth] - v[i + maxwidth][j] + h[i + maxwidth][j + maxwidth] - h[i][j + maxwidth] + mat[i + maxwidth][j] + mat[i][j + maxwidth];
//                }
//
//            }
//        }
